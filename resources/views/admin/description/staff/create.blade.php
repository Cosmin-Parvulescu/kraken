...
@section('breadcrumbs')
    ...
    <li>{!! link_to_action('Admin\Description\Staff\StaffController@create', 'New Staff', [$tenantId, $descriptionId], ['class' => 'btn btn-link']) !!}</li>
@endsection

@section('content')
    {!! Form::model(new App\Kraken\Description\Staff, ['action' => ['Admin\Description\Staff\StaffController@store', $tenantId, $descriptionId]]) !!}
